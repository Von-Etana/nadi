            ...
            {!requires2FA ? (
              <>
                ...
                <div className="flex justify-end">
                  <button type="button" className="text-sm text-[#ea580c] hover:underline">
                    Forgot Password?
                  </button>
                </div>
              </>
          ...
          {!requires2FA && (
            <>
              ...
              <div className="grid grid-cols-2 gap-4">
                <button className="flex items-center justify-center gap-2 h-12 rounded-xl border border-[#e2e2e2] hover:bg-[#f5f5f5] transition-colors">
