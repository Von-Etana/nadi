...
- Configure production `FRONTEND_URL` / `CORS_ORIGINS`, `FLUTTERWAVE_SECRET_KEY`, `FLUTTERWAVE_WEBHOOK_SECRET`, `RESEND_API_KEY`, and `QUIDAX_API_KEY` on the backend host. Include `https://nadi-digital.vercel.app` in the backend CORS origins.
